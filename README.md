...
一个基于公开语料整理的通用开源 AI persona skill，参考 `colleague-skill` 的方法，将户晨风拆分为可复用的 `Work Skill + Persona` 双层结构，并把他的高辨识度表达与稳定判断方式整理为可迁移的人格提示资产。
...
这意味着你可以在保留原始许可证声明的前提下自由使用、修改、分发和二次集成这套 skill。
